...
import ScrollableChatIndividual from "./ScrollableChatIndividual";
            ...
            {loading ? (
              ...
              <div className="messages">
                {selectedChat.isGroupChat ? (
                  ...
                  <ScrollableChatIndividual messages={messages} />
                )}
              </div>
            )}
            <FormControl marginTop={3} onKeyDown={handleOnKeyDown} isRequired>
              {isTyping ? (
                <div>
                  <Lottie
